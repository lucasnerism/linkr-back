...
postsRouter.post('/posts/:id/comments', validateToken, postsController.createComment);
postsRouter.get('/posts/:id/comments', validateToken, postsController.getPostComments);
